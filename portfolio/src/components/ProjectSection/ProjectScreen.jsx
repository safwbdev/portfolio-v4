...
const ProjectScreen = () => {
    ...
    return (
        <>
            <div className={`bg-black/75 z-2 absolute w-full h-full top-0 lleft-0 items-center justify-center ${expandProject && currentProject ? 'flex' : 'hidden'}`}>
                <div className="pop">
                    <button
                        onClick={closeScreen}
                ...
                <div className="bg-zinc-900 flex w-9/12">
